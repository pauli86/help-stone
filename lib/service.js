...
const Service = {
    ...
    selectProject:(flag,idx)=>{
        let title = Service.projectAll[flag][idx].project.title;
        let desc = Service.projectAll[flag][idx].project.desc;
        Service.project = Service.projectAll[flag][idx];
        console.log('[ select project ] flag = ',flag,' , idx = ',idx,' , title = ',title,' , desc = ',desc);
    }
}
